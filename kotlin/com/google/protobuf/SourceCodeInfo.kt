...
data class SourceCodeInfo(
  ...
  class Builder(private val message: SourceCodeInfo) : Message.Builder<SourceCodeInfo, Builder>() {
    override fun build(): SourceCodeInfo = message
  }
  ...
  data class Location(
     ...
     */
    @field:WireField(tag = 2, adapter = "com.squareup.wire.ProtoAdapter#INT32") val span: List<Int>
        = emptyList(),
    /**
    ...
    class Builder(private val message: Location) : Message.Builder<Location, Builder>() {
      override fun build(): Location = message
    }
    ...
    companion object {
      ...
      val ADAPTER: ProtoAdapter<Location> = object : ProtoAdapter<Location>(
        ...
        override fun encodedSize(value: Location): Int = 
          ...
          ProtoAdapter.INT32.asRepeated().encodedSizeWithTag(2, value.span) +
        ...
        override fun encode(writer: ProtoWriter, value: Location) {
          ...
          ProtoAdapter.INT32.asRepeated().encodeWithTag(writer, 2, value.span)
